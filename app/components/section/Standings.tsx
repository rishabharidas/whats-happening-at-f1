...
export default async function Standings() {
  ...
  const driversMap = Array.isArray(drivers) ? drivers.reduce(
    (acc, driver: any) => {
  ...
  const driversStandings = Array.isArray(driversStandingsData) ? driversStandingsData.map(
    (driver: any) => ({
      ...driver,
  ...
  const constructorsStandings = Array.isArray(teamsStandingsData) ? teamsStandingsData.map((team: any) => ({
    ...team,
